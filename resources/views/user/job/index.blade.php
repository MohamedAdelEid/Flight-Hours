                        ...
                        <tbody class="bg-white text-center divide-y dark:divide-gray-700 dark:bg-gray-700">
                            <tr class="text-gray-700 dark:text-gray-400">
                                ...
                                <td class="flex justify-center items-center px-4 py-3">
                                    <div class="flex justify-center items-center text-sm w-fit">

                                        <form action="">
                                            <button
                                                class="flex items-center justify-between px-1 ml-1 py-2 text-sm font-medium leading-5 text-blue-400 rounded-lg dark:text-blue-400 focus:outline-none transition duration-200 ease-in-out hover:text-blue-600"
                                                aria-label="Edit">
                                        ...
                                        <form action="">
                                            <button
                                                class="flex items-center justify-between px-1 py-2 text-sm font-medium leading-5 text-red-400 rounded-lg dark:text-red-400 focus:outline-none transition duration-200 ease-in-out hover:text-red-600"
                                                aria-label="Delete">
                                                <svg class="w-5 h-5" aria-hidden="true" fill="currentColor"
                                                    viewBox="0 0 20 20">
